...
.. code-block:: bash
   ...
   # Cleanup everything
   python -m schedarray cleanup --completed --failed --cancelled --timeout
...
+======================+===========================+
| ``sbatch script.sh`` | ``schedarray submit       |
|                      | --script script.sh``      |
+----------------------+---------------------------+
| ``squeue -u user``    | ``schedarray list         |
|                      | --user user``            |
+----------------------+---------------------------+
| ``squeue -t RUNNING`` | ``schedarray list        |
|                      | --state running``        |
+----------------------+---------------------------+
| ``scancel <job_id>``  | ``schedarray cancel      |
|                      | <job_id>``               |
+----------------------+---------------------------+
| ``scontrol show job  | ``schedarray status       |
| <job_id>``           | <job_id>``               |
+----------------------+---------------------------+
