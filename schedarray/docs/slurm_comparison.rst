...
+======================+===========================+===========================+
| Submit job          | ``sbatch script.sh``       | ``schedarray submit       |
|                      |                           | --script script.sh``      |
+----------------------+---------------------------+
| List jobs           | ``squeue``                 | ``schedarray list``       |
+----------------------+---------------------------+
| Show job status     | ``squeue -j <job_id>``     | ``schedarray status       |
|                      |                           | <job_id>``                |
+----------------------+---------------------------+
| Cancel job          | ``scancel <job_id>``       | ``schedarray cancel       |
|                      |                           | <job_id>``                |
+----------------------+---------------------------+
| **Delete job**      | ❌ Not available           | ✅ ``schedarray delete    |
|                      |                           | <job_id>``                |
+----------------------+---------------------------+
